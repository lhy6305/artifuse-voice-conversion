...
- minimax: EXP-20260316-032-offline-mvp-d76-round1-1-d26-init-post-d59-singleton-sparse-micropause-sampler-d22late-late-fusedhidden-boost-200step-calibration (val=2.107936, special_delta=0.246555, zero_e_evt=1.937766, zero_z_art=0.424651)
...
- objective: minimax
- constraints: {'max_validation_budget_over_best': None, 'min_zero_e_evt_delta_target_loss_total': 1.9703, 'min_zero_z_art_delta_target_loss_total': 0.424651}
- is_feasible: True
...
- objective: special
- constraints: {'max_validation_budget_over_best': 0.017686, 'min_zero_e_evt_delta_target_loss_total': None, 'min_zero_z_art_delta_target_loss_total': None}
- is_feasible: True
...
- selected_anchor: EXP-20260316-013-offline-mvp-d22-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-200step-calibration (val=2.125622, special_delta=0.238578, zero_e_evt=1.864222, zero_z_art=0.669467)
...
- objective: special
- constraints: {'max_validation_budget_over_best': 0.017686, 'min_zero_e_evt_delta_target_loss_total': None, 'min_zero_z_art_delta_target_loss_total': 0.710849}
- is_feasible: True
- eligible_anchor_ids: ['EXP-20260316-015-offline-mvp-d33-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-shortpausegate-priority-fused-hidden-200step-calibration']
- selected_anchor: EXP-20260316-015-offline-mvp-d33-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-shortpausegate-priority-fused-hidden-200step-calibration (val=2.122699, special_delta=0.239846, zero_e_evt=1.9703, zero_z_art=0.710849)

## recommended policy
- {'default_policy': 'default_minimax', 'route_switch_rules': [{'when': 'max_validation_budget_over_best < 0.0', 'use_policy': 'validation_strict', 'selected_anchor_id': 'EXP-20260316-032-offline-mvp-d76-round1-1-d26-init-post-d59-singleton-sparse-micropause-sampler-d22late-late-fusedhidden-boost-200step-calibration'}, {'when': 'max_validation_budget_over_best >= 0.0 and (special_priority is false and z_art_priority is false)', 'use_policy': 'default_minimax', 'selected_anchor_id': 'EXP-20260316-032-offline-mvp-d76-round1-1-d26-init-post-d59-singleton-sparse-micropause-sampler-d22late-late-fusedhidden-boost-200step-calibration'}, {'when': 'max_validation_budget_over_best >= 0.017686 and (special_priority is true or z_art_priority is true)', 'use_policy': 'special_push', 'selected_anchor_id': 'EXP-20260316-013-offline-mvp-d22-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-200step-calibration'}]}
