...
- best_final_special_experiment: EXP-20260316-013-offline-mvp-d22-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-200step-calibration @ step 200 (val=2.125622, special_delta=0.238578, zero_e_evt=1.864222, zero_z_art=0.669467)
- best_final_e_evt_experiment: EXP-20260316-015-offline-mvp-d33-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-shortpausegate-priority-fused-hidden-200step-calibration @ step 200 (val=2.122699, special_delta=0.239846, zero_e_evt=1.9703, zero_z_art=0.710849)
- best_positive_control_late_special_experiment: EXP-20260316-015-offline-mvp-d33-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-shortpausegate-priority-fused-hidden-200step-calibration @ step 150 (val=2.168489, special_delta=0.229425, zero_e_evt=2.032546, zero_z_art=0.664676)
- best_validation_guarded_special_experiment: EXP-20260316-015-offline-mvp-d33-round1-1-d7-init-d10-teacher-consolidation-teacher-consistency-shortpausegate-priority-fused-hidden-200step-calibration @ step 150 (val=2.168489, special_delta=0.229425, zero_e_evt=2.032546, zero_z_art=0.664676)
