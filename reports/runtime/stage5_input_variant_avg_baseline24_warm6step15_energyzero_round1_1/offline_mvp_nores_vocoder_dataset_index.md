...
- output_dir: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_energyzero_round1_1
- train_package_count: 0
- validation_package_count: 3
- control_family_overrides: [{"family": "E_log_rms_norm", "mode": "zero", "targets": ["periodic.E_log_rms_norm", "noise.E_log_rms_norm"]}]

## Train Packages

## Validation Packages
- target::chapter3_3_firefly_162: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_energyzero_round1_1/packages/validation/target_chapter3_3_firefly_162/train_targets/offline_mvp_nores_vocoder_train_targets.pt variant={"control_family_overrides": [{"family": "E_log_rms_norm", "mode": "zero", "targets": ["periodic.E_log_rms_norm", "noise.E_log_rms_norm"]}], "transform_summary": {"transformations": ["periodic.E_log_rms_norm -> zero[10:11]", "noise.E_log_rms_norm -> zero[10:11]"], "control_family_overrides": [{"family": "E_log_rms_norm", "mode": "zero", "targets": ["periodic.E_log_rms_norm", "noise.E_log_rms_norm"]}]}, "source_package_path": "F:/proj_dev/tmp/workdir4/reports/runtime/streaming_student_stage5_dataset_packages_avg_baseline24_warm6step15_contractv2_normfix_validation3_round1_2/packages/validation/target__chapter3_3_firefly_162/train_targets/offline_mvp_nores_vocoder_train_targets.pt"}
