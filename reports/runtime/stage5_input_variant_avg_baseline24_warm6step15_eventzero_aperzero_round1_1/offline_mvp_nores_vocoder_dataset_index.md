...
- generated_at: 2026-03-28T14:01:32
...
- output_dir: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_eventzero_aperzero_round1_1
- train_package_count: 0
- validation_package_count: 3
- control_family_overrides: [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt", "noise.event_probs"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}]

## Train Packages

## Validation Packages
- target::chapter3_3_firefly_162: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_eventzero_aperzero_round1_1/packages/validation/target_chapter3_3_firefly_162/train_targets/offline_mvp_nores_vocoder_train_targets.pt variant={"control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt", "noise.event_probs"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}], "transform_summary": {"transformations": ["noise.e_evt -> zero[0:8]", "noise.aper -> zero[8:9]"], "control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}]}, "source_package_path": "F:/proj_dev/tmp/workdir4/reports/runtime/streaming_student_stage5_dataset_packages_avg_baseline24_warm6step15_contractv2_normfix_validation3_round1_2/packages/validation/target__chapter3_3_firefly_162/train_targets/offline_mvp_nores_vocoder_train_targets.pt"}
- target::chapter3_3_firefly_138: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_eventzero_aperzero_round1_1/packages/validation/target_chapter3_3_firefly_138/train_targets/offline_mvp_nores_vocoder_train_targets.pt variant={"control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt", "noise.event_probs"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}], "transform_summary": {"transformations": ["noise.e_evt -> zero[0:8]", "noise.aper -> zero[8:9]"], "control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}]}, "source_package_path": "F:/proj_dev/tmp/workdir4/reports/runtime/streaming_student_stage5_dataset_packages_avg_baseline24_warm6step15_contractv2_normfix_validation3_round1_2/packages/validation/target__chapter3_3_firefly_138/train_targets/offline_mvp_nores_vocoder_train_targets.pt"}
- target::chapter3_4_firefly_106: F:/proj_dev/tmp/workdir4/reports/runtime/stage5_input_variant_avg_baseline24_warm6step15_eventzero_aperzero_round1_1/packages/validation/target_chapter3_4_firefly_106/train_targets/offline_mvp_nores_vocoder_train_targets.pt variant={"control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt", "noise.event_probs"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}], "transform_summary": {"transformations": ["noise.e_evt -> zero[0:8]", "noise.aper -> zero[8:9]"], "control_family_overrides": [{"family": "event_family", "mode": "zero", "targets": ["noise.e_evt"]}, {"family": "aper", "mode": "zero", "targets": ["noise.aper"]}]}, "source_package_path": "F:/proj_dev/tmp/workdir4/reports/runtime/streaming_student_stage5_dataset_packages_avg_baseline24_warm6step15_contractv2_normfix_validation3_round1_2/packages/validation/target__chapter3_4_firefly_106/train_targets/offline_mvp_nores_vocoder_train_targets.pt"}
