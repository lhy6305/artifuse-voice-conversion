...
## Status
- experiment_id: streaming_student_stage_hiddenproj_smoke_round1_1
- created_at: 2026-03-26T00:41:51
...
- teacher_hidden_projection: [2, 38, 64]
- timing_pause_boundary_logits: [2, 38, 1]
- timing_terminal_boundary_logits: [2, 38, 1]
- timing_final_clause_logits: [2, 38, 1]
- student_hidden: [2, 38, 96]
- conditioning: [2, 38, 32]
- teacher_fused_hidden_projection: [2, 38, 64]
- z_art: [2, 38, 8]
- event_logits: [2, 38, 8]
- event_probs: [2, 38, 8]
- r_res: [2, 38, 0]
...
## Notes
- Stage3 timing auxiliary contract keeps semantic weighting/routing disabled so timing supervision can be isolated via explicit auxiliary targets.
