...
## 全量数据概况
- target.record_count: 624
- target.group_counts: {"<root>": 616, "no_text_voice": 8}
- target.duration_sec: {"min": 0.436984, "p50": 5.008991, "mean": 6.13149, "max": 25.493991}
- target.clean_char_count: {"min": 1.0, "p50": 21.0, "mean": 24.913462, "max": 85.0}
...
- target.validation_groups: {"no_text_voice": 8}
...
- target.validation_count: 62
- target.special_eval_count: 0
- target.validation_groups: {"<root>": 62}
