...
- teacher_e_evt_target_shaping_mode: hard_box_v1
- index_path: F:/proj_dev/tmp/workdir4/data_prep/round1_1/streaming_student_teacher_labels_eevt_directionaltargetstaterebalancehardbox_round1_1/teacher_label_index.jsonl
...
- teacher_event_bridge_mode_counts: {'acoustic_directional_targetstate_rebalance_v1': 592}
- teacher_event_target_shaping_mode_counts: {'hard_box_v1': 592}
...
- teacher_event_bridge_mode_counts: {'acoustic_directional_targetstate_rebalance_v1': 66}
- teacher_event_target_shaping_mode_counts: {'hard_box_v1': 66}
...
- teacher_event_bridge_mode_counts: {'acoustic_directional_targetstate_rebalance_v1': 8}
- teacher_event_target_shaping_mode_counts: {'hard_box_v1': 8}
...
- teacher_e_evt bridge mode for this export = acoustic_directional_targetstate_rebalance_v1.
- teacher_e_evt target shaping mode for this export = hard_box_v1.
