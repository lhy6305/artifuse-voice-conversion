...
- summary: initialized
- failures:
- follow_up: metrics file -> F:/proj_dev/tmp/workdir4/reports/experiments/EXP-20260316-020-offline-mvp-d65-round1-1-d7-init-post-d59-singleton-sparse-micropause-sampler-teacher-gate-weaktail-20step-calibration.metrics.json
