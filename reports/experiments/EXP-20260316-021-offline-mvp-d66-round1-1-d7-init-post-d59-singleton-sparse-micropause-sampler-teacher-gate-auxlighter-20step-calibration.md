...
- summary: initialized
- failures:
- follow_up: metrics file -> F:/proj_dev/tmp/workdir4/reports/experiments/EXP-20260316-021-offline-mvp-d66-round1-1-d7-init-post-d59-singleton-sparse-micropause-sampler-teacher-gate-auxlighter-20step-calibration.metrics.json
