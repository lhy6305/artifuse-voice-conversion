...
- experiment_id: EXP-20260315-056-offline-mvp-d39-round1-1-d7-init-d10-teacher-consistency-phase-handoff-early-core-late-shortpause-fused-hidden-20step-calibration
- dry_run: False
...
## 时间
- started_at: 2026-03-15T21:23:55
- ended_at: 2026-03-15T21:23:58
- duration_sec: 3.296694
...
- active_until_step: 0
- priority_ratio: 0.0
- schedule_phases: [{'active_until_step': 10, 'priority_ratio': 0.25, 'priority_structure_types': [], 'exclude_structure_types': [], 'priority_pool_memberships': ['challenge_proxy_core'], 'priority_record_ids': [], 'exclude_pool_memberships': []}, {'active_until_step': 20, 'priority_ratio': 0.25, 'priority_structure_types': [], 'exclude_structure_types': [], 'priority_pool_memberships': ['challenge_proxy_core', 'short_pause_no_terminal'], 'priority_record_ids': [], 'exclude_pool_memberships': []}]
- phase_priority_record_counts: [{'active_until_step': 10, 'priority_ratio': 0.25, 'priority_record_count': 16}, {'active_until_step': 20, 'priority_ratio': 0.25, 'priority_record_count': 19}]
- min_clause_count: 0
