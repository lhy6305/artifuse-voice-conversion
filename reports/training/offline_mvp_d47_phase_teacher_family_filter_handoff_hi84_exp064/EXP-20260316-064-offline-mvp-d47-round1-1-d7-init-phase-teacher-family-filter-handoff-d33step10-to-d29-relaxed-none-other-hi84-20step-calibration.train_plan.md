...
- experiment_id: EXP-20260316-064-offline-mvp-d47-round1-1-d7-init-phase-teacher-family-filter-handoff-d33step10-to-d29-relaxed-none-other-hi84-20step-calibration
- dry_run: False
...
## 时间
- started_at: 2026-03-16T00:28:41
- ended_at: 2026-03-16T00:28:44
- duration_sec: 3.593529
...
- active_until_step: 0
- priority_ratio: 0.0
- schedule_phases: [{'active_until_step': 10, 'priority_ratio': 0.25, 'priority_structure_types': [], 'exclude_structure_types': [], 'priority_pool_memberships': ['challenge_proxy_core', 'short_pause_no_terminal'], 'priority_record_ids': [], 'exclude_pool_memberships': [], 'min_special_proximity_score': 0.0, 'required_final_terminal_types': [], 'required_utterance_structure_types': []}, {'active_until_step': 20, 'priority_ratio': 0.25, 'priority_structure_types': [], 'exclude_structure_types': [], 'priority_pool_memberships': ['challenge_proxy_relaxed'], 'priority_record_ids': [], 'exclude_pool_memberships': [], 'min_special_proximity_score': 0.84, 'required_final_terminal_types': ['none'], 'required_utterance_structure_types': ['other']}]
- phase_priority_record_counts: [{'active_until_step': 10, 'priority_ratio': 0.25, 'priority_record_count': 19}, {'active_until_step': 20, 'priority_ratio': 0.25, 'priority_record_count': 15}]
- min_clause_count: 0
...
- teacher_consistency: {'enabled': True, 'teacher_checkpoint_path': 'reports/training/offline_mvp_d29_d26_init_d22_teacher_cross_anchor_consolidation_exp045/checkpoints/EXP-20260315-045-offline-mvp-d29-round1-1-d26-init-d22-teacher-cross-anchor-consolidation-20step-calibration.step20.pt', 'weight': 0.15, 'event_weight': 1.0, 'z_art_weight': 1.0, 'acoustic_weight': 0.0, 'fused_hidden_weight': 0.0, 'pool_memberships': ['challenge_proxy_relaxed'], 'min_special_proximity_score': 0.84, 'required_final_terminal_types': ['none'], 'required_utterance_structure_types': ['other'], 'schedule_phases': [{'active_until_step': 10, 'weight': 0.15, 'event_weight': 1.0, 'z_art_weight': 1.0, 'acoustic_weight': 0.0, 'fused_hidden_weight': 0.05, 'pool_memberships': ['challenge_proxy_core', 'short_pause_no_terminal'], 'teacher_checkpoint_path': 'reports/training/offline_mvp_d33_d7_init_d10_teacher_consistency_shortpause_fused_hidden_exp050/checkpoints/EXP-20260315-050-offline-mvp-d33-round1-1-d7-init-d10-teacher-consistency-shortpausegate-fused-hidden-20step-calibration.step10.pt', 'min_special_proximity_score': 0.0, 'max_special_proximity_score': 1.0, 'required_final_terminal_types': [], 'required_utterance_structure_types': []}, {'active_until_step': 20, 'weight': 0.15, 'event_weight': 1.0, 'z_art_weight': 1.0, 'acoustic_weight': 0.0, 'fused_hidden_weight': 0.0, 'pool_memberships': ['challenge_proxy_relaxed'], 'teacher_checkpoint_path': 'reports/training/offline_mvp_d29_d26_init_d22_teacher_cross_anchor_consolidation_exp045/checkpoints/EXP-20260315-045-offline-mvp-d29-round1-1-d26-init-d22-teacher-cross-anchor-consolidation-20step-calibration.step20.pt', 'min_special_proximity_score': 0.84, 'max_special_proximity_score': 1.0, 'required_final_terminal_types': ['none'], 'required_utterance_structure_types': ['other']}], 'teacher_checkpoint_paths': ['F:/proj_dev/tmp/workdir4/reports/training/offline_mvp_d29_d26_init_d22_teacher_cross_anchor_consolidation_exp045/checkpoints/EXP-20260315-045-offline-mvp-d29-round1-1-d26-init-d22-teacher-cross-anchor-consolidation-20step-calibration.step20.pt', 'F:/proj_dev/tmp/workdir4/reports/training/offline_mvp_d33_d7_init_d10_teacher_consistency_shortpause_fused_hidden_exp050/checkpoints/EXP-20260315-050-offline-mvp-d33-round1-1-d7-init-d10-teacher-consistency-shortpausegate-fused-hidden-20step-calibration.step10.pt']}
- sampler_mode: priority_interleave

## 最新 step 指标
- step: 20
- effective_learning_rate: 0.00015
- loss_total: 4.977297306060791
- target.loss_total: 2.532383680343628
- source.loss_total: 2.4280624389648438
- grad_norm: 3.3007171154022217
