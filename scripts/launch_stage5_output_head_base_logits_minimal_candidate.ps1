param(
  ...
  [double]$WaveformDecoderBaseLogitsNoiseEnergyAbsZeroLagCorrActiveWeight = 0.0,
  [double]$WaveformDecoderBaseLogitsFrameDeltaWeight = 0.0,
  [double]$WaveformDecoderBaseLogitsNoiseFocusFrameDeltaWeight = 0.0,
  [double]$WaveformDecoderBaseLogitsFrameAdjacentCosineWeight = 0.0,
  [double]$WaveformDecoderBaseLogitsResidualShapeDeltaNoiseFocusAbsZeroLagCorrWeight = 0.0,
...
$command = @(
  ...
  $WaveformDecoderBaseLogitsNoiseEnergyAbsZeroLagCorrActiveWeight.ToString($culture),
  "--waveform-decoder-base-logits-frame-delta-weight",
  $WaveformDecoderBaseLogitsFrameDeltaWeight.ToString($culture),
  "--waveform-decoder-base-logits-noise-focus-frame-delta-weight",
  $WaveformDecoderBaseLogitsNoiseFocusFrameDeltaWeight.ToString($culture),
  "--waveform-decoder-base-logits-frame-adjacent-cosine-weight",
  $WaveformDecoderBaseLogitsFrameAdjacentCosineWeight.ToString($culture),
  "--waveform-decoder-base-logits-residual-shape-delta-noise-focus-abs-zero-lag-corr-weight",
  $WaveformDecoderBaseLogitsResidualShapeDeltaNoiseFocusAbsZeroLagCorrWeight.ToString($culture),
