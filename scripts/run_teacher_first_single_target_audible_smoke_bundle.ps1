    ...
    $defaultSpecs = @(
      @{
        ...
        notes = @(
          ...
          "Preferred default main-listening smoke case because it is same-content with the target while preserving real source-to-target timing mismatch."
        )
      },
      @{
        ...
        notes = @(
          ...
          "Preferred default main-listening smoke case because it keeps the smoke bundle on real same-content source-to-target transfer instead of generic segment coverage."
        )
      }
    )
  } else {
